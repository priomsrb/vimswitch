...
class TestProfileDataIo(BaseTestCase):
    ...
    def test_copy_usesGetProfileFiles_fromSettings(self):
        ...
        srcFile = os.path.normpath('/home/foo/.vimswitch/profiles/test.vimrc/testProfileFile')
    ...
    def test_copy_whenDirExists_copiesDir(self):
        ...
        srcDir = os.path.normpath('/home/foo/.vimswitch/profiles/test.vimrc/.vim')
    ...
    def test_copy_usesGetProfileDirs_fromSettings(self):
        ...
        srcDir = os.path.normpath('/home/foo/.vimswitch/profiles/test.vimrc/testProfileDir')
