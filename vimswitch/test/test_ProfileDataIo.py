...
class TestProfileDataIo(unittest.TestCase):
    ...
    def test_delete_whenFileDoesNotExists_doesNotDeleteFile(self):
        ...
        assertNoCall(self.diskIo.deleteFile, '/home/foo/.vimrc')
    ...
    def test_delete_usesGetProfileFiles_fromSettings(self):
        ...
        self.diskIo.deleteFile.assert_any_call('/home/foo/testProfileFile')
    ...
    def test_delete_deletesMultipleFiles(self):
        ...
        self.diskIo.deleteFile.assert_any_call('/home/foo/file1')
        self.diskIo.deleteFile.assert_any_call('/home/foo/file2')
    ...
    def test_delete_whenDirExists_deletesDir(self):
        ...
        self.diskIo.deleteDir.assert_any_call('/home/foo/.vim')
    ...
    def test_delete_whenDirDoesNotExists_doesNotDeleteDir(self):
        ...
        assertNoCall(self.diskIo.deleteDir, '/home/foo/.vim')
    ...
    def test_delete_usesGetProfileDirs_fromSettings(self):
        ...
        self.diskIo.deleteDir.assert_any_call('/home/foo/testProfileDir')
    ...
    def test_delete_deletesMultipleDirs(self):
        ...
        self.diskIo.deleteDir.assert_any_call('/home/foo/dir1')
        self.diskIo.deleteDir.assert_any_call('/home/foo/dir2')
    ...
    def test_copy_whenFileExists_copiesFile(self):
        srcPath = '/home/foo/.vimswitch/test.vimrc'
        destPath = '/home/foo'
        self.diskIo.fileExists.return_value = True

        self.profileDataIo.copy(srcPath, destPath)

        srcFile = '/home/foo/.vimswitch/test.vimrc/.vimrc'
        destFile = '/home/foo/.vimrc'
    ...
    def test_copy_usesGetProfileFiles_fromSettings(self):
        ...
        srcFile = '/home/foo/.vimswitch/test.vimrc/testProfileFile'
        destFile = '/home/foo/testProfileFile'
        self.diskIo.copyFile.assert_any_call(srcFile, destFile)
    ...
    def test_copy_copiesMultipleFiles(self):
        ...
        srcFile1 = '/home/foo/.vimswitch/test.vimrc/file1'
        destFile1 = '/home/foo/file1'
        srcFile2 = '/home/foo/.vimswitch/test.vimrc/file2'
        destFile2 = '/home/foo/file2'
    ...
    def test_copy_whenDirExists_copiesDir(self):
        ...
        srcDir = '/home/foo/.vimswitch/test.vimrc/.vim'
        destDir = '/home/foo/.vim'
    ...
    def test_copy_usesGetProfileDirs_fromSettings(self):
        ...
        srcDir = '/home/foo/.vimswitch/test.vimrc/testProfileDir'
        destDir = '/home/foo/testProfileDir'
        self.diskIo.copyDir.assert_any_call(srcDir, destDir)
    ...
    def test_copy_copiesMultipleDirs(self):
        ...
        srcDir1 = '/home/foo/.vimswitch/test.vimrc/dir1'
        destDir1 = '/home/foo/dir1'
        srcDir2 = '/home/foo/.vimswitch/test.vimrc/dir2'
        destDir2 = '/home/foo/dir2'
